 ...
 * - Corrects logo path to 'assets/logo.png' (as found in your repo)
 * - Adds White Badge to Footer Logo for visibility on dark background
...
(function () {
    ...
    const links = `
        ...
        <style>
            ...
            /* Footer Logo Badge - Makes logo pop on dark background */
            .footer-logo-wrap {
                background: white;
                padding: 10px 18px;
                border-radius: 12px;
                ...
                <div class="footer-grid">
                    ...
                    <div class="footer-col">
                        ...
                        <ul class="footer-links">
                            ...
                            <li><a href="${relPath}compress.html">Compress</a></li>
                        </ul>
                    </div>
                    <div class="footer-col">
                        <h4>Company</h4>
